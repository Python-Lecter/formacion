...
# while True:
#
#     new_window_name = psutil.Process(os.getpid()).name()
#
...
#
# id_app = os.getpid()
# meta_app = psutil.Process(id_app)
# dir_app = meta_app.exe()
# bash_app = meta_app.cmdline()
# app_name = meta_app.name()
# while True:
#     time.sleep(0.5)
#     print(id_app)
#     print(app_name)
...
# # 'python3' python3.8
# print(p.exe())
# # '/usr/bin/python3.5' /usr/bin/python3.8
# print(p.cmdline())
# # ['python3'] ['/usr/bin/python3.8', '/home/cross/PycharmProjects/formacion/LinuxInfo.py']
